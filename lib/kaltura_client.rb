...
module Kaltura
	...
	class KalturaAccessControlContextTypeHolder < KalturaObjectBase
	...
	class KalturaStorageProfile < KalturaObjectBase
		...
		attr_accessor :url_manager_params
	...
	class KalturaAccessControlBlockAction < KalturaAccessControlAction

	end

	class KalturaAccessControlPreviewAction < KalturaAccessControlAction
		attr_accessor :limit
	...
	class KalturaStorageProfileBaseFilter < KalturaFilter
		...
		def protocol_equal=(val)
			@protocol_equal = val.to_i
		end
	end
	...
	class KalturaCategoryEntryAdvancedFilter < KalturaSearchOperator
		attr_accessor :categories_match_or
	...
	class KalturaIndexAdvancedFilter < KalturaSearchOperator
	...
	class KalturaBatchJobBaseFilter < KalturaBaseJobFilter
		...
		def last_worker_remote_equal=(val)
			@last_worker_remote_equal = val.to_i
		end
	...
	class KalturaMixingService < KalturaServiceBase
		...
		def request_flattening(entry_id, file_format, version=-1)
			...
			# Format to convert
			client.add_param(kparams, 'fileFormat', file_format);
			# Version to flatten (If not set, latest will be used)
			client.add_param(kparams, 'version', version);
	...
	class KalturaPartnerService < KalturaServiceBase
		...
		# 	 
		def register(partner, cms_password='', template_partner_id=KalturaNotImplemented)
			kparams = {}
	...
	class KalturaThumbAssetService < KalturaServiceBase
		...
		# 	 
		def serve(thumb_asset_id, version=KalturaNotImplemented)
			kparams = {}
